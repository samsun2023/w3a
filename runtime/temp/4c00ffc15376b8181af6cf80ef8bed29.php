<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./tpl/mscms/mobile/novel/lists.html";i:1675867255;s:37:"./tpl/mscms/mobile/common/header.html";i:1675867255;s:37:"./tpl/mscms/mobile/common/footer.html";i:1675867255;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<link rel="stylesheet" href="__ROOT__/tpl/mscms/mobile/static/css/n-list.css">
    <div class="vault-box">
        <div class="vault-top">
            <div class="tab">
                <a href="<?php echo url('video/lists'); ?>" >课程</a>
                ...
                <li>
                    <a href="<?php echo url('novel/show',array('id'=>$vo['id'])); ?>">
                        ...
                        <div class="novel-box">
                            ...
                            <span class="text"><?php echo (isset($vo['short_info']) && ($vo['short_info'] !== '')?$vo['short_info']:"暂没简介"); ?></span>
                            <div>
                                <div class="box-f">
                                    <span><i class="btn fn-time"></i> 20<?php echo date('y-m-d',$vo['update_time']); ?></span>
