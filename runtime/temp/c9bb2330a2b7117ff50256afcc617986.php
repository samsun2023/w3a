    ...
    <div class="stui-pannel_bd">
      <div class="col-pd clearfix"> <?php if(!(empty($notice) || (($notice instanceof \think\Collection || $notice instanceof \think\Paginator ) && $notice->isEmpty()))): ?>
        <div class="copyright-tips">
          <div class="layout-cont" style="font-size:15px"> <span style="color:red;"><i class="fa fa-volume-up"></i>&nbsp;&nbsp;&nbsp;<b>公告：</b></span>
            <ul>
    ...
    <div class="col-lg-wide-75 col-xs-1 padding-0">
      <div class="col-pd stui-pannel-bg">
        <div class="stui-pannel_hd">
          <div class="stui-pannel__head clearfix"> <a class="more text-muted pull-right" href="<?php echo url('video/lists',array('orderCode'=>'new')); ?>">更多 <i class="icon iconfont icon-more"></i></a>
            <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_1.png"/> <a href="<?php echo url('video/lists',array('orderCode'=>'new')); ?>">最新课程</a> </h3>
          </div>
        </div>
        <div class="stui-pannel_bd clearfix">
  ...
  <div class="stui-pannel-box padding-0">
    <div class="col-lg-wide-75 col-xs-1 padding-0">
      <div class="col-pd stui-pannel-bg">
        <div class="stui-pannel_hd">
          <div class="stui-pannel__head clearfix"> <a class="more text-muted pull-right" href="<?php echo url('video/lists',array('orderCode'=>'new')); ?>">更多 <i class="icon iconfont icon-more"></i></a>
            <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_1.png"/> <a href="<?php echo url('video/lists',array('orderCode'=>'new')); ?>">猜你喜欢</a> </h3>
          </div>
        </div>
        <div class="stui-pannel_bd clearfix">
          <ul class="stui-vodlist clearfix">
...
<div class="stui-pannel clearfix">
  <div class="stui-pannel-box padding-0">
    <div class="col-lg-wide-75 col-xs-1 padding-0">
      <div class="col-pd stui-pannel-bg">
        <div class="stui-pannel_hd">
          <div class="stui-pannel__head clearfix"> <a class="more text-muted pull-right" href="<?php echo url('video/lists',array('orderCode'=>'reco')); ?>">更多 <i class="icon iconfont icon-more"></i></a>
            <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_1.png"/> <a href="<?php echo url('video/lists',array('orderCode'=>'reco')); ?>">推荐课程</a> </h3>
          </div>
        </div>
        <div class="stui-pannel_bd clearfix">
          <ul class="stui-vodlist clearfix">
...
<div class="stui-pannel clearfix">
  <div class="stui-pannel-box padding-0">
    <div class="col-lg-wide-75 col-xs-1 padding-0">
      <div class="col-pd stui-pannel-bg">
        <div class="stui-pannel_hd">
          <div class="stui-pannel__head clearfix"> <a class="more text-muted pull-right" href="<?php echo url('video/lists',array('orderCode'=>'hot')); ?>">更多 <i class="icon iconfont icon-more"></i></a>
            <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_1.png"/> <a href="<?php echo url('video/lists',array('orderCode'=>'hot')); ?>">热门课程</a> </h3>
          </div>
        </div>
        <div class="stui-pannel_bd clearfix">
          <ul class="stui-vodlist clearfix">
  ...
  <div class="stui-pannel-box">
    <div class="stui-pannel_hd">
      <div class="stui-pannel__head clearfix">
        <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_26.png"/> 站点链接 </h3>
      </div>
    </div>
    <div class="stui-pannel_bd clearfix">
      <div class="col-xs-1">
