<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./tpl/mscms/images/lists.html";i:1675873055;s:30:"./tpl/mscms/common/header.html";i:1571122115;s:30:"./tpl/mscms/common/footer.html";i:1675869491;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="col-pd stui-pannel-bg">
  <div class="stui-pannel_hd">
	...
	<a class="more text-muted pull-right" href="/images/lists.html?orderCode=hot&tag_id=0&sub_cid=0&cid=0&area_id=0" style="margin-left:10px;">热门</a>
	<a class="more text-muted pull-right" href="/images/lists.html?orderCode=lastTime&tag_id=0&sub_cid=0&cid=0&area_id=0" style="margin-left:10px;">最新</a> 
	<a class="more text-muted pull-right" href="/images/lists.html"  style="margin-left:10px;">全部</a>
    <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_19.png"/> <a href="#">图片列表</a> </h3>
    </div>
  </div>
  <div class="stui-pannel_bd clearfix">
    <div id="album">
      <div class="album-list clearfix layout-cont s-body">
        <div class="wrap"> <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <div class="list" >
            <div class="img"> <a href="<?php echo url('images/show',array('id'=>$vo['id'])); ?>" target="_blank"> <img class="lazy" data-original="<?php echo $vo['cover']; ?>" src="__ROOT__/tpl/mscms/msvodx/images/jzz.gif"> </a> </div>
            <div class="con"> <a href="<?php echo url('images/show',array('id'=>$vo['id'])); ?>" target="_blank"><?php echo $vo['title']; ?></a> </div>
            <div class="con"> <span style=""><i class="fa fa-eye" style="color:#666666;margin-right:5px;"></i><?php echo $vo['click']; ?></span> <span style="margin-left:8px;"> <i class="fa fa-dot-circle-o" style="color:#666666;margin-left:30px;"></i> <?php echo $vo['good']; ?></span> <span style="float:right;">20<?php echo date("y-m-d",$vo['update_time']); ?></span> </div>
          </div>
