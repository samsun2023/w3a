<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:28:"./tpl/mscms/novel/lists.html";i:1675873187;s:30:"./tpl/mscms/common/header.html";i:1571122115;s:30:"./tpl/mscms/common/footer.html";i:1675869491;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="stui-pannel stui-pannel-bg clearfix">
  <div class="stui-pannel_hd">
    ...
    <ul class="stui-screen__list type-slide bottom-line-dot clearfix" id="sub_box">
      ...
      <li class="<?php if(empty($sub_cid) || (($sub_cid instanceof \think\Collection || $sub_cid instanceof \think\Paginator ) && $sub_cid->isEmpty())): ?>swiper-slide active<?php endif; ?>"><a href="#" data="0">全部</a></li>
      ...
      <li class="<?php if($sub_cid == $vo['id']): ?>swiper-slide active<?php endif; ?>"><a data="<?php echo $vo['id']; ?>" href="#"><?php echo $vo['name']; ?></a></li>
      <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <?php endif; ?>
...
<div class="col-pd stui-pannel-bg">
  <div class="stui-pannel_hd">
    <div class="stui-pannel__head clearfix">
      <h3 class="title"> <img src="__ROOT__/tpl/mscms/msvodx/picture/icon_5.png"/> <a href="#">图片列表</a> </h3>
    </div>
  </div>
  <div class="stui-pannel_bd clearfix">
    <ul class="stui-vodlist__media active col-pd clearfix">
      ...
      <li>
        <div class="thumb"> <a class="w-thumb stui-vodlist__thumb active lazyload" href="<?php echo url('novel/show',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" data-original="<?php echo $vo['thumbnail']; ?>" style="border-radius:5px;background-image: url(<?php echo $vo['thumbnail']; ?>);"> </a> </div>
        <div class="detail">
          <h4 class="title"><a href="<?php echo url('novel/show',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a></h4>
          <p class="hidden-sm hidden-xs"><?php echo (isset($vo['short_info']) && ($vo['short_info'] !== '')?$vo['short_info']:"暂没简介"); ?>...</p>
          <p class="margin-0 font-12"><span class="hidden-xs"><span class="text-muted">阅读：<?php echo $vo['click']; ?> 次</span><span class="split-line"></span></span> <span class="text-muted">时间：</span>20<?php echo date("y-m-d",$vo['update_time']); ?></p>
        </div>
      </li>
      <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
