...
var stui = {
	...
	'common': {//公共基础
		...
		'history': function() {
			if($("#stui_history").length){
				if($.cookie("recente")){
		            ...
		            $("#stui_history").append("<p style='padding: 80px 0; text-align: center'>"+lang('NullPay')+"</p>");
		...
		'share': function(){
			if(baidushare!=0){
				$(".share").html('<span class="bds_shere"></span><a class="bds_qzone" data-cmd="qzone" title="'+lang('ShareQQ')+'"></a><a class="bds_tsina" data-cmd="tsina" title="'+lang('ShareSina')+'"></a><a class="bds_weixin" data-cmd="weixin" title="'+lang('ShareWx')+'"></a><a class="bds_tqq" data-cmd="tqq" title="'+lang('ShareTwb')+'"></a><a class="bds_sqq" data-cmd="sqq" title="'+lang('ShareQQfri')+'"></a><a class="bds_bdhome" data-cmd="bdhome" title="'+lang('ShareBaidu')+'"></a><a class="bds_tqf" data-cmd="tqf" title="'+lang('ShareTxFri')+'"></a><a class="bds_youdao" data-cmd="youdao" title="'+lang('ShareYdao')+'"></a><a class="bds_more" data-cmd="more" title="'+lang('More')+'"></a>');
