...
class Homepage extends BaseController
{
    ...
    public function __construct(Request $request = null)
    {
        ...
        $this->assign('userVideoTotal',Db::name('video')->where(array('user_id'=>$uid,'status'=>1,'is_check'=>1,'pid'=>0))->count());    //会员课程总数
    ...
    public function videoPage(Request $request)
    {
        ...
        $this->assign('page_title', $this->userinfo['nickname'] . '的课程');
        $this->assign('navTopTitle', $this->userinfo['nickname'] . '的课程');
