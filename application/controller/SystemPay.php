...
class SystemPay extends BaseController
{
    ...
    public function recharge(Request $request)
    {
        ...
        switch ($curSysPayCode) {
            ...
            case 'yunyiPay':
                ...
                $paymentList[] = ['payName' => '支付宝支付', 'payCode' => 'yunyiPay|aliPay', 'payIcon' => '/tpl/'.$this->themeBasename.'/static/images/Alipay.png'];
                $paymentList[] = ['payName' => '微信支付', 'payCode' => 'yunyiPay|wxPay', 'payIcon' => '/tpl/'.$this->themeBasename.'/static/images/WeChat.png'];
                break;
            case 'haoPay':
                ...
                $paymentList[] = ['payName' => '支付宝支付', 'payCode' => 'haoaPay|aliPay', 'payIcon' => '/tpl/'.$this->themeBasename.'/static/images/Alipay.png'];
                $paymentList[] = ['payName' => '微信支付', 'payCode' => 'haoaPay|wxPay', 'payIcon' => '/tpl/'.$this->themeBasename.'/static/images/WeChat.png'];
                $paymentList[] = ['payName' => 'QQ钱包', 'payCode' => 'haoaPay|qqPay', 'payIcon' => '/tpl/'.$this->themeBasename.'/static/images/QQ.png'];
                break;
            case 'nativePay':
    ...
    public function createOrder(Request $request)
    {
        ...
        $video_id =  $request->post('video_id/d', '0');
    ...
    public function pay(Request $request)
    {
        ...
        } elseif (strtolower($order->payment_code) == 'yunyipay') {
            //not native payment
            $payClass = '\\systemPay\\' . $order->payment_code;
            try {
                $payer = new $payClass();
