...
INSERT INTO `ms_admin_config` VALUES (3, 'base', '网站标题', 'site_title', '课程点播系统专家', '');
INSERT INTO `ms_admin_config` VALUES (4, 'base', '网站关键词', 'site_keywords', '课程系统,课程系统软件源码,课程程序,课程app开发,网络课程系统,嵌入式课程app开发 互联网创新模式,互联网技术服务解决方案', '网站标题是体现一个网站的主旨，要做到主题突出、标题简洁、连贯等特点，建议不超过28个字');
INSERT INTO `ms_admin_config` VALUES (5, 'base', '网站描述', 'site_description', '魅思是国内领先课程系统开发商,国内领先的课程系统程序软件开发、课程源码出售,核心课程系统技术,适用美女秀场课程、电商课程、教育课程、金融课程、游戏等多行业。魅思提供全方位的互联网产业链服务。我们洞察市场、深谙技术、引入资本运作,帮助您在互联网领域实现互联网化转型,抓住互联网+传统企业的新机遇！', '网页的描述信息，搜索引擎采纳后，作为搜索结果中的页面摘要显示，建议不超过80个字');
...
INSERT INTO `ms_admin_config` VALUES (15, 'base', '消费有效期', 'message_validity', '1', '课程付费了之后，多长时间内可以免费观看');
...
INSERT INTO `ms_admin_config` VALUES (21, 'video', '课程提成', 'commission', '1', '填写1-10的数字，如1，就是1/100');
...
INSERT INTO `ms_admin_config` VALUES (29, 'attachment', '课程存储方式', 'video_save_server_type', 'yunzhuanma', '课程资源存储的方式');
...
INSERT INTO `ms_admin_config` VALUES (43, 'commission', '课程提成', 'video_commission', '10', '课程提成，填写1-100的值');
...
INSERT INTO `ms_admin_config` VALUES (49, 'video', '播放课程时广告显示时长', 'play_video_ad_time', '3', '对前置广告生效');
...
INSERT INTO `ms_admin_config` VALUES (63, 'base', '新增资源审核', 'resource_examine_on', '1', '客户上传了新资源（课程、图册、小说）是否需要审核，1为需要，0为不需要');
INSERT INTO `ms_admin_config` VALUES (64, 'base', '课程重审', 'video_reexamination', '1', '客户编辑课程信息后是否需要重新审核，如修改了标题，标签，课程地址等');
...
INSERT INTO `ms_admin_config` VALUES (74, 'video', '课程自动入库分类id', 'sync_add_video_classid', '10', NULL);
INSERT INTO `ms_admin_config` VALUES (75, 'video', '自动入库的课程是否需要审核', 'sync_add_video_need_review', '0', NULL);
...
INSERT INTO `ms_admin_config` VALUES (88, 'gather', '课程采集入库分类', 'resource_gather_video_classid', '14', '课程采集入库的分类');
INSERT INTO `ms_admin_config` VALUES (89, 'gather', '资讯采集入库分类', 'resource_gather_novel_classid', '17', '小说采集入库的分类');
INSERT INTO `ms_admin_config` VALUES (90, 'gather', '采集的课程是否需要审核', 'resource_gather_video_need_review', '1', '采集的课程是否需要审核');
...
INSERT INTO `ms_admin_config` VALUES (93, 'gather', '采集的课程观看金币数', 'resource_gather_video_view_gold', '1', '采集的课程观看金币数');
...
INSERT INTO `ms_admin_config` VALUES (96, 'base', '上传课程奖励', 'upload_video_reward', '', '用户上传课程审核通过后可获取奖励金币数');
INSERT INTO `ms_admin_config` VALUES (97, 'base', '上传资讯奖励', 'upload_novel_reward', '', '用户上传资讯审核通过后可获取奖励金币数');
INSERT INTO `ms_admin_config` VALUES (98, 'base', '资源上传权限', 'upload_permissions', '1', '资源上传权限，1为所有人都可以上传，2为只有会员可以上传');
INSERT INTO `ms_admin_config` VALUES (99, 'video', '手机端广告转跳地址', 'web_pre_ad_url', '1', '手机端广告转跳地址');
INSERT INTO `ms_admin_config` VALUES (100, 'video', '手机端广告内容地址', 'web_pre_ad', '1', '手机端前置广告内容');
INSERT INTO `ms_admin_config`(`group`,`title`,`name`,`value`,`remarks`) VALUES ('commission', '提成奖励类型', 'is_money_kmoney', '1', '1为金币，2为K币');
-- ----------------------------
...
CREATE TABLE `ms_atlas_good_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `atlas_id` int(11) DEFAULT NULL COMMENT '点赞的课程id',
...
CREATE TABLE `ms_class`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源分类表(课程|小说|图片)' ROW_FORMAT = Dynamic;
...
INSERT INTO `ms_class` VALUES (27, '舞蹈课程', 0, 0, 1, 1513910194, '0', '0', 1, 0);
...
CREATE TABLE `ms_draw_money_account`  (
  ...
  `type` tinyint(1) DEFAULT 1 COMMENT '收款方式（1.支付宝2银行卡3.微信）',
  ...
  `img` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收款二维码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 54 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提现帐户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_gratuity_record`  (
  ...
  `content_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '打赏内容类型 1:课程 2:图片 3:小说',
...
CREATE TABLE `ms_member`  (
  ...
  `recom_id` int(11) DEFAULT NULL COMMENT '推荐者id',
  ...
  `money` float(11, 1) DEFAULT 0.0 COMMENT '金币',
  ...
  `agent_config` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '代理相关站点设置',
  `access_token` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '验证token',
  `openid` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '第三方登录openid',
  `unionid` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信用户全平台唯一id',
  `k_money` float(11, 2) NOT NULL DEFAULT 0.00 COMMENT 'K币',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员信息表' ROW_FORMAT = Compact;
...
INSERT INTO `ms_menu` VALUES (12, 11, '最新课程', '{\"cid\":\"2\",\"type\":1}', 0, 1, 2);
INSERT INTO `ms_menu` VALUES (28, 26, '游戏课程', '{\"cid\":\"9\",\"type\":1}', 9, 1, 2);
INSERT INTO `ms_menu` VALUES (14, 13, '鲁班小说', '{\"cid\":\"11\",\"type\":3}', 0, 1, 2);
INSERT INTO `ms_menu` VALUES (31, 26, '所有课程', '/video/lists', 1, 1, 1);
INSERT INTO `ms_menu` VALUES (26, 0, '课程', '{\"cid\":\"video\"}', 2, 1, 2);
INSERT INTO `ms_menu` VALUES (17, 16, '最新图片', '{\"cid\":\"3\",\"type\":2}', 0, 1, 2);
INSERT INTO `ms_menu` VALUES (25, 0, '首页', '/', 1, 1, 1);
INSERT INTO `ms_menu` VALUES (21, 11, '最热课程', '{\"cid\":\"10\",\"type\":1}', 0, 1, 2);
INSERT INTO `ms_menu` VALUES (24, 11, '百度', 'http://www.baidu.com', 0, 1, 1);
INSERT INTO `ms_menu` VALUES (29, 26, '最新课程', '/video/lists/orderCode/lastTime.html', 3, 1, 1);
INSERT INTO `ms_menu` VALUES (32, 26, '最热课程', '/video/lists/orderCode/hot.html', 0, 1, 1);
...
CREATE TABLE `ms_novel_good_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `novel_id` int(11) DEFAULT NULL COMMENT '点赞的课程id',
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `add_time` int(10) DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `ms_payment`  VALUES (1, 'codePay', '码支付', '[{\"name\":\"merchant_id\",\"type\":\"string\",\"value\":\"18709\",\"desc\":\"\\u5546\\u6237id\"},{\"name\":\"key\",\"type\":\"string\",\"value\":\"UM6iE8R9UD44MHxyB0qRvlXpF6jgqfOk\",\"desc\":\"\\u7801\\u652f\\u4ed8\\u901a\\u4fe1\\u5bc6\\u94a5\"},{\"name\":\"min_money\",\"type\":\"string\",\"value\":\"0.01\",\"desc\":\"\\u6700\\u4f4e\\u652f\\u4ed8\\u91d1\\u989d\"}]', 0, 1, 1514888879, 1525410844);
INSERT INTO `ms_payment`  VALUES (5, 'wxPay', '微信支付', '[{\"name\":\"appid\",\"type\":\"string\",\"value\":\"wx1e076868fbfb4195\",\"desc\":\"\\u516c\\u4f17\\u53f7appid\"},{\"name\":\"secret_key\",\"type\":\"string\",\"value\":\"2bbd1843b672d41b96c18893915365a5\",\"desc\":\"\\u516c\\u4f17\\u53f7SecretKey\"},{\"name\":\"mch_id\",\"type\":\"string\",\"value\":\"1458366102\",\"desc\":\"\\u5546\\u6237\\u53f7\"},{\"name\":\"key\",\"type\":\"string\",\"value\":\"Jgp2OmiuIBskZ523bll6cS6xhvpwCrTk\",\"desc\":\"API\\u5bc6\\u94a5\"},{\"name\":\"notify_url\",\"type\":\"string\",\"value\":\"http:\\/\\/payer.free.ngrok.cc\\/pay_notify\\/wxpayNotify\",\"desc\":\"\\u901a\\u77e5\\u56de\\u8c03\\u5730\\u5740\"},{\"name\":\"exchange_rate\",\"type\":\"int\",\"value\":\"6.3\",\"desc\":\"\\u7f8e\\u5143\\u4eba\\u6c11\\u5e01\\u6c47\\u7387\"},{\"name\":\"min_money\",\"type\":\"int\",\"value\":\"0.01\",\"desc\":\"\\u6700\\u5c0f\\u652f\\u4ed8\\u91d1\\u989d\"}]', 1, 0, 1514888906, 1526353040);
INSERT INTO `ms_payment` VALUES (3, 'aliPay', '支付宝支付', '[{\"name\":\"appid\",\"type\":\"string\",\"value\":\"2017071907814717\",\"desc\":\"appid\"},{\"name\":\"md5_key\",\"type\":\"string\",\"value\":\"bgsdshzscyaqprnmlk5i3oa03dkh7euc\",\"desc\":\"MD5\\u5bc6\\u94a5\"},{\"name\":\"user_private_key\",\"type\":\"textarea\",\"value\":\"MIIEpAIBAAKCAQEA9TVmwFMr5zhLR1R2g1SwXaOe6tJLL2diOslZqoo+0TX\\/KjgqmaUaj0zeqV4ypZvu6bKmBDpEejV7H2l8NYR7K9c7Nr1r\\/LzbYEXaf9IU1ZjHx47MULJ4d+76Oj+E3EcByuB7SKkyk1gh94pEv2YBK8Rvt22foud\\/wyhkLF1YhMOBCiJsCjvIKwkb8SVKhU8sRnKxvpjaBQGkq53ybe8Kn+XoSpkLjR5dhRmY9cKUcJydQE0uv77XOCT4u8tbS2zSbr+ZRqPuLcngJmZhaFe3OECwfxok5Lgs7vBgSPVnar+78cqS71x9d1Py\\/O72pScm7D10PZ10iB8rJhdfdpzFbwIDAQABAoIBAQCZl\\/Cbyb03YSiuLnbpvrOWg\\\\/zeDb9tNrI1rqhZd1DXgNqm0hlKWaIpuGnnSnBzfmoVb5Vj45JBXyRu6\\/d82ykjDoYyqDcfbJi22bh49DIMIYy5ufp1JNz73rJHnEo1asvRFloAdlSCRAoGBAPccidAoJzHNXIM4R89CuSpgJNJBJ5464kk2ktxQMJU519WbmVhFrT6xnA\\/8hn8EIgUIhcjTJ+JwBLwgU58f8d2wh+1h5gpMQP0oLunyFMUx4cwrUc8U49frYwNpRAZdMU3baUfcT\\/c1K3YwYoJbUEzL4pjnLHXB2d\\/DQZGFxoX\\/AoGAaXYSvH4T74Jl91kKyg+UknoDaVFbwT8mRqF2RnWdmqof4POWiIlFfzJzylA++ATfRjcUfgSmPVfAWeQgf9kBvbbINxtAxJvwQr1MEgwCmApZ67FOBIVypZLSVtuirP5Gc2Pxg4xEzYGF65jj59ilnvakJk6QXS7ybIcXXEjryIECgYEAq5F25b1bKSrKNpkW0oIjCZbjOc\\/e7+82OVrYsHpEoPceMcLsvurxk\\/vAvSC5SOrXq+L08DAbGw5nWy6eoHaPeTodxeUY0MGMxbfmiqt3XEp72UOic0KvxrQ5dJ7bigeeOc5C1I\\/UPXD\\/EfoaCyPXJtrQIxUuOzwyRzfMCHt3EIUCgYAlqQ\\/KpdnUXUoRpv\\/pvPSAGqwONCDiZkmvHqEKTiMJ0mzZ\\/lACpbh+Nqmh9WTR47myVqAiMfOkG+wiZ+OsbyJh2jbQVV2ltaPVm3FekZQ9VVwNOQR3hbjZwwCCL5nsmKnDIWPZv8O8meZoXLYC5V6\\/QkHEMQqGTVQ3k5buZ4o2XA==\",\"desc\":\"\\u5f00\\u53d1\\u8005\\u79c1\\u94a5\"},{\"name\":\"ali_public_key\",\"type\":\"textarea\",\"value\":\"1111\",\"desc\":\"\\u652f\\u4ed8\\u5b9d\\u516c\\u94a5\"},{\"name\":\"min_money\",\"type\":\"int\",\"value\":\"0.01\",\"desc\":\"\\u6700\\u5c0f\\u652f\\u4ed8\\u91d1\\u989d\"},{\"name\":\"exchange_rate\",\"type\":\"int\",\"value\":\"6.3\",\"desc\":\"\\u7f8e\\u5143\\u4eba\\u6c11\\u5e01\\u6c47\\u7387\"},{\"name\":\"notify_url\",\"type\":\"string\",\"value\":\"http:\\/\\/payer.free.ngrok.cc\\/pay_notify\\/alipayNotify\",\"desc\":\"\\u5f02\\u6b65\\u901a\\u77e5\\u5730\\u5740\"},{\"name\":\"return_url\",\"type\":\"string\",\"value\":\"http:\\/\\/payer.free.ngrok.cc\\/member\\/member\",\"desc\":\"\\u652f\\u4ed8\\u5b8c\\u6210\\u56de\\u8df3\\u5730\\u5740\"}]', 1, 0, 1514888916, 1528940805);
INSERT INTO `ms_payment`  VALUES (2, 'paypal', 'paypal支付', '[{\"name\":\"business\",\"type\":\"string\",\"value\":\"280360721-facilitator@qq.com\",\"desc\":\"\\u5546\\u6237\\u53f7\"},{\"name\":\"notify_url\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\\/notify.php\",\"desc\":\"\\u5f02\\u6b65\\u901a\\u77e5\\u5730\\u5740\"},{\"name\":\"return\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\",\"desc\":\"\\u652f\\u4ed8\\u5b8c\\u6210\\u56de\\u8df3\\u5730\\u5740\"},{\"name\":\"cancel_return\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\",\"desc\":\"\\u53d6\\u6d88\\u8fd4\\u56de\\u5730\\u5740\"},{\"name\":\"currency_code\",\"type\":\"string\",\"value\":\"USD\",\"desc\":\"\\u5e01\\u79cd\\u9ed8\\u8ba4\\u7f8e\\u5143\"},{\"name\":\"min_money\",\"type\":\"int\",\"value\":\"0.01\",\"desc\":\"\\u6700\\u5c0f\\u652f\\u4ed8\\u91d1\\u989d\"}]', 1, 0, 1525851713, 1525924325);
INSERT INTO `ms_payment` VALUES (6, 'haoPay', '好支付', '[{\"name\":\"business\",\"type\":\"string\",\"value\":\"10002\",\"desc\":\"\\u5546\\u6237\\u53f7\"},{\"name\":\"key\",\"type\":\"string\",\"value\":\"t4ig5acnpx4fet4zapshjacjd9o4bhbi\",\"desc\":\"\\u5546\\u6237\\u79d8\\u94a5\"},{\"name\":\"notify_url\",\"type\":\"string\",\"value\":\"http:\\/\\/ce.msvodx.com\\/pay_notify\\/haoapayNotify\",\"desc\":\"\\u5f02\\u6b65\\u901a\\u77e5\\u5730\\u5740\"},{\"name\":\"return\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\",\"desc\":\"\\u652f\\u4ed8\\u5b8c\\u6210\\u56de\\u8df3\\u5730\\u5740\"},{\"name\":\"min_money\",\"type\":\"int\",\"value\":\"0.01\",\"desc\":\"\\u6700\\u5c0f\\u652f\\u4ed8\\u91d1\\u989d\"}]', 1, 1, NULL, 1528884176);
INSERT INTO `ms_payment`  VALUES (7, 'kuyunPay', '酷云支付', '[{\"name\":\"business\",\"type\":\"string\",\"value\":\"2018104\",\"desc\":\"\\u5546\\u6237\\u53f7\"},{\"name\":\"key\",\"type\":\"string\",\"value\":\"WdiTPpCgHPMYsgmIaFUZoKOihdpvLzcT\",\"desc\":\"\\u5546\\u6237\\u79d8\\u94a5\"},{\"name\":\"notify_url\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\\/pay_notify\\/kuyunpayNotify\",\"desc\":\"\\u5f02\\u6b65\\u901a\\u77e5\\u5730\\u5740\"},{\"name\":\"return\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\",\"desc\":\"\\u652f\\u4ed8\\u5b8c\\u6210\\u56de\\u8df3\\u5730\\u5740\"},{\"name\":\"min_money\",\"type\":\"int\",\"value\":\"0.01\",\"desc\":\"\\u6700\\u5c0f\\u652f\\u4ed8\\u91d1\\u989d\"}]', 1, 1, 1528884176, 1530235075);
INSERT INTO `ms_payment`( `pay_code`, `pay_name`, `config`, `status`, `is_third_payment`, `add_time`, `update_time`) VALUES ('yunyiPay', '云易支付', '[{\"name\":\"business\",\"type\":\"string\",\"value\":\"295\",\"desc\":\"商户id"},{\"name\":\"key\",\"type\":\"string\",\"value\":\"da72fd6e4108d1283b\",\"desc\":\"密钥key"},{\"name\":\"notify_url\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\\/pay_notify\\/kuyunpayNotify\",\"desc\":\"异步通知地址"},{\"name\":\"return\",\"type\":\"string\",\"value\":\"http:\\/\\/v.msvodx.com\",\"desc\":\"支付完成回跳地址"},{\"name\":\"min_money\",\"type\":\"int\",\"value\":\"0.01\",\"desc\":\"最小支付金额"}]', 1, 1, 1528884176, 1531816212);
...
CREATE TABLE `ms_tag`  (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `type` int(2) DEFAULT 1 COMMENT '所属模块1课程，2图片，3小说',
  `status` int(2) DEFAULT 1 COMMENT '开启状态1为开启，0为关闭',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源标签表(课程|小说|图片)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_video`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程标题',
  `info` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '说明',
  `short_info` varchar(90) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '短说明',
  `key_word` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '关键词',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '课程播放地址',
  ...
  `play_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '课程时长',
  `click` int(11) DEFAULT 0 COMMENT '总点击量',
  `good` int(11) DEFAULT 0 COMMENT '总点赞数',
  `thumbnail` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '缩略图',
  ...
  `type` tinyint(2) DEFAULT 0 COMMENT '课程集为1 单课程为0',
  ...
  `sort` int(3) DEFAULT 0 COMMENT '课程分集序号',
  `is_check` int(1) DEFAULT 0 COMMENT '是否审核 。1审核通过，2审核未通过，0待审核',
  `hint` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '驳回原因',
  `img` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '课程截图',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_video_collection`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT 0 COMMENT '用户id',
  `video_id` int(11) DEFAULT 0 COMMENT '课程id',
  `collection_time` int(10) DEFAULT 0 COMMENT '收藏时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_good_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `video_id` int(11) DEFAULT NULL COMMENT '点赞的课程id',
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `add_time` int(10) DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程点赞记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_watch_log`  (
  ...
  `view_time` int(10) NOT NULL COMMENT '观看时间',
  `is_try_see` int(1) DEFAULT 0 COMMENT '是否为试看，1：试看',
  `is_myself` int(1) DEFAULT 0 COMMENT '是否为自己发布的课程,1:是,0:不是',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程观看日志表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for ms_gold_log_k
-- ----------------------------
DROP TABLE IF EXISTS `ms_gold_log_k`;
CREATE TABLE `ms_gold_log_k`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `gold` float(11, 1) DEFAULT NULL COMMENT 'K币数',
  `add_time` int(11) DEFAULT NULL COMMENT '添加时间',
  `module` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '来源模块',
  `explain` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '说明描述',
  `type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0为分成，1为提现',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 43 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'K币明细表' ROW_FORMAT = Dynamic;
